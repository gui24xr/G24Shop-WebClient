...
import {  ProductsContainer, CartContainer, OrderPanel, CreatingShippingPoints, AddressInMaps } from './components/components.index'
...
function App() {
  ...
  useEffect(()=>{
    ...
    setProfile(user, getAccessTokenSilently)
